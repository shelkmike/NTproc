...
### Performance
NTproc utilizes a single CPU thread and is capable of processing 1 000 000 reads in approximately an hour. If a faster performance is required, a user can split the input FASTQ file into batches and run several instances of NTproc independently. If you would like NTproc to make this automatically, notify me via issues (https://github.com/shelkmike/NTProc/issues).
